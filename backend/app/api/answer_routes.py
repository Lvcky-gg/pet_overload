...
def current_answer():
    ...
    if answers:
        ...
        return (
            jsonify({"message": "Answers could not be found", "statusCode": 404}),
            404,
        )
...
def add_vote(id):
    ...
    new_vote = AnswerVote.add_answer_vote(
        is_liked=is_liked, user_id=user_id, answer_id=id
    )
...
def specific_answer(id):
    ...
    if answer:
        ...
        dictionary = {
            ...
            "vote_score": len(answer.answer_votes),
            "owner": owner_dict,
        }
