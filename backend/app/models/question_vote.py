...
class QuestionVote(db.Model):
    ...
    question_id = db.Column(
        db.Integer,
        db.ForeignKey(add_prefix_for_prod("questions.id"), ondelete="CASCADE"),
        nullable=False,
    )
    ...
    @classmethod
    def get_question_vote_by_id(
        cls, id: int, session=None
    ) -> Union["QuestionVote", None]:
        """
    ...
    @classmethod
    def get_question_vote_by_user_and_question(
        cls, user_id: int, question_id: int, session=None
    ) -> Union["QuestionVote", None]:
        """
    ...
    @classmethod
    def add_question_vote(
        cls, is_liked: bool, user_id: int, question_id: int
    ) -> "QuestionVote":
        """
