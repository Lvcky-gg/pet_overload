...
class Question(db.Model):
    ...
    question_answers = db.relationship("Answer", back_populates="question",cascade="all, delete-orphan")
    question_votes = db.relationship("QuestionVote", back_populates="question",cascade="all, delete-orphan")
